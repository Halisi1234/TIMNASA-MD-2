...
zokou({
  ...
  if (!_0x3c7f3f) {
    return _0x3b1d82("Give me a valid github username like: " + _0x4fdb82 + "https://github.com/Halisi1234/");
  }
  const _0x5d3fd3 = await fetch("https://api.github.com/users/timnasa md" + _0x3c7f3f);
  ...
  const _0x24d738 = _0x546dd2.email;'Halisimd212@gmail.com 
